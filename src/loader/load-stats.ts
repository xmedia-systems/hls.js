...
export default class LoadStats implements LoaderStats {
  ...
  parsing: HlsProgressivePerformanceTiming = { start: 0, end: 0, executeCumulative: 0, cumulative: 0 };
  buffering: HlsProgressivePerformanceTiming = { start: 0, end: 0, executeCumulative: 0, cumulative: 0 };
}
